...
'File:               ClsBank_EventArgs_CustomerCreated.vb
'Author:             Hari Chandana Paruchuri   
'Description:        Business Logic for the event of Creating Customer  
'Date:               2016 Nov 1
...
Public Class Bank_EventArgs_CustomerCreated
...
#Region "Constructors"
    ...
    Public Sub New(ByVal pCustomer As Customer,
                   Optional ByVal pRefDate As Date = Nothing)
        MyBase.New()
        _customer = pCustomer
...
#Region "Get/Set Methods"
    ...
    Public ReadOnly Property customer As Customer
        ...
        End Get
    End Property
    Public ReadOnly Property refDate As Date
        Get
            Return _refDate
        End Get
    End Property
...
#Region "Behavioral Methods"
    ...
    Private Function _toString() As String
        ...
        If _refDate = Date.MinValue Then

            tmpstr = "( BANK_EVENTARGS_CUSTOMERCREATED : " _
                  & " Customer = " & _customer.ToString()

        Else

            tmpstr = "( BANK_EVENTARGS_CUSTOMERCREATED : " _
                  & " Customer = " & _customer.ToString(_refDate)
...
End Class 'Bank_EventArgs_CustomerCreated