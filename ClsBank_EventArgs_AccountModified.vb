...
'File:               ClsBank_EventArgs_AccountModified.vb
'Author:             Hari Chandana Paruchuri   
'Description:        Business Logic class for the event of Account Modified.
'Date:               2016 Nov 1
'                    - Created the class and the filled the template with 
...
Public Class Bank_EventArgs_AccountModified
...
#Region "Constructors"
    ...
    Public Sub New(ByVal pAccount As Account)
        MyBase.New()
        _account = pAccount
...
#Region "Behavioral Methods"
    ...
    Private Function _toString() As String
        ...
        tmpstr = "( BANK_EVENTARGS_ACCOUNTMODIFIED : " _
...
#End Region 'Events
End Class 'Bank_EventArgs_AccountModified
